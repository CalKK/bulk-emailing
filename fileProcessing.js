...
const INFO_PREFIXES = ['info@', 'sales@', 'company@', 'company.kenya@', 'companyinitials@', 'contact@', 'contactcentre@', 'contactcentrekenya@', 'customerservice@', 'contactus@', 'headoffice@', 'talk-us@', 'letstalk@'];
