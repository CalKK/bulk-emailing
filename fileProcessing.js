...
const INFO_PREFIXES = ['info@', 'sales@', 'company@', 'company.kenya@company.africa', 'enquiries@', 'companyinitials@', 'contact@', 'contactcentre@', 'contactcentrekenya@', 'customerservice@', 'contactus@', 'headoffice@', 'talk-us@', 'letstalk@'];
